...
const Nav = () => {
  ...
  return (
    <nav className="flex-between w-full mb-16 pt-3">
        ...
        <Image className="" width={50} height={50} src="/assets/images/logo.svg"/>
        ...
        <div className="sm:flex hidden">
            {
              session?.user?
                (<div className="md:flex gap-3 md:gap-5" >
                    ...
                    <Link href="/profile"><Image src={session?.user.image} alt="profile" width={37} height={37} className="rounded-full"/></Link>
                </div>):(
                <>
